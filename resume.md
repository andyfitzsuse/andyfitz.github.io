...
* Successful transition & ramp of Content Automation offering across the entire group formerly known as Outfit into the Brandfolder business.
* Pitched and won net new clients with all deal sizes between  USD$40-350k 
* Resurrected major DAM closed/lost opportunities into Content Automation and portfolio deals.
* Directed and produced enterprise-qualified POC's, curating the experience to industry workload with a 90%+ win rate
* Managed high-risk enterprise accounts in a professional services and customer success capacity
* Worked with former product and engineering teams to ensure platform strategy, commercial prioritisation, innovative opportunities.
* Reset relationship with key customers preventing churn during volatile transitions and renewals
...
<svg  class="redhat printonly" viewBox="0 0 93 22.02"> <use href="#rhlogo"/></svg>

### Lead Brand Manager - Global Regions
...
* Managed vendors (ISV's, Event, & Design Agencies)
* Coordinated public corporate branded activities.
* Built and maintained brand-related software projects.  
...
* **Innovative Auctions** (formerly PowerAuctions) — Communications & Product
...
time{display:none}
h4,h3{font-weight:500}
h4{font-size:1em; text-transform: uppercase; letter-spacing:.05em}
h1 img{max-width: 2em; display:inline-block; vertical-align:middle;margin-right:.25em;  }
article h1{line-height:.9em;font-weight:900; font-size: 3em; letter-spacing:-.02em; margin-top:0 !important; color:var(--fg-2);}

article svg{fill:var(--neutral); max-width:40VW; max-height:4em;}
article svg + svg{margin-left:1em}
...
@media print {
  ...
  .always-break{page-break-after:always}
  .screenonly{display:none}
  .printonly{display:block;}
  .printonly a{color:var(--brand)}
  .hotlinks a{font-weight:500 !important}
  ...
  body{font-size: .75em;line-height:1.3em;}
    .last-page ul{page-break-after:avoid !important}
    .last-page ul + h2{margin-top:3em}

}

.summary{background-color: var(--bg-2); padding:1em; font-size:.8em;}
.summary li:before{display:none}
.summary em{font-size:.66em; font-style:normal; color:var(--fg-2); box-shadow: 0 0 0 .05em var(--neutral) ; padding:.2em .5em; border-radius: .3em}

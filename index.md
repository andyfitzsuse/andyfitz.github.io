...
.mission dfn:hover{color:var(--brand)}
...
{ pointer-events:none;
 ...
 width: 100%; left:0; min-width: 11rem;line-height:1em; background-color: var(--bg-3); color:var(--fg); text-align:left; padding: .85em;  box-shadow: 0 0 0 .12em, 0 .3em 1.5em rgba(0,0,0,0.3);
...
.mission-values{position:relative; padding: 1em 0 5em 0; margin: 2em 0; background-color: var(--bg-3)}

...
<br>
<h2 class="scroll more"> <span>Need more?</span> </h2>
...
.more{letter-spacing:-.025em; display:grid; place-content:center; position:relative;}
...
#timezones{background-color:var(--bg-3); padding: 2em 1em; position:relative}
